...
public class OsPdf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jcAudios.add(JcAudio.createFromURL("Modern Operating System", phyaudio));
        jcAudios.add(JcAudio.createFromURL("System Programming & Operating System", mathsaudio));
        jcAudios.add(JcAudio.createFromURL("Operating System Concepts", cmsaudio));
        jcAudios.add(JcAudio.createFromURL("BOS 6 & 6.2", ceaudio));
